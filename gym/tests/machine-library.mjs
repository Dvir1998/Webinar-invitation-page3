...
for(const viewport of viewports){
 ...
 await context.addInitScript(()=>{
  const state={version:'9.1.2',profile:{name:'Gym QA',complete:true,days:4,goal:'lean_gain',weight:65,height:165,age:28},prefs:{theme:'bright'},logs:[],meals:[],weights:[],measures:[],chat:[],photos:[]};
