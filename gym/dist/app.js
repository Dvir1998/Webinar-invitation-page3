...
'use strict';
const DG_BUILD_ID='edd37d7e77cb4f937e2be0d518a4082477c9ba8b';
const VERSION='6.0.0';
...
async function loadMachineSprite(){
 machineSprite='assets/gym-machines.webp?v=9.2.0';
...
const DG_GYM_LIBRARY_VERSION='9.2.0';
...
const DG_DAILY_TRACKER_VERSION='9.2.0';
...
function dgInjectDailyTrackerV92(){
 const home=$('#screen-home');if(!home)return;home.querySelector('#dgDailyTrackerV92')?.remove();
 ...
 const card=document.createElement('section');card.id='dgDailyTrackerV92';card.className=`card dg-daily-tracker ${progress===3?'complete':''}`;card.setAttribute('aria-labelledby','dgDailyTitleV92');
 ...
 const hero=home.querySelector('.hero');if(hero)hero.before(card);else home.appendChild(card);
...
setTimeout(()=>{dgEnsureDailyTrackingV92();dgInjectDailyTrackerV92()},520);
